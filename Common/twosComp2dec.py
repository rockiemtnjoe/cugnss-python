def twosComp2dec(binaryNumber):
    ...
    # binaryNumber (in Python it can be a string or list), represented as a row vector of
    ...
    if isinstance(binaryNumber, list):
        binaryNumber = ''.join(binaryNumber)
    if not isinstance(binaryNumber, str):
        raise ValueError('Input must be a string or list of "0"/"1".')
